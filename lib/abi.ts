...
export const chaseGemAbi = [
  ...
  { type: 'error', inputs: [], name: 'PaymentNotEnough' },
  ...
  },
  {
    ...
    inputs: [
      {
        name: 'gem',
        internalType: 'struct ChaseGem.Gem',
        type: 'tuple',
        components: [
      ...
      { name: 'tagIds', internalType: 'uint8[]', type: 'uint8[]' },
    ],
    name: 'addNewGem',
    outputs: [],
  ...
  {
    type: 'function',
    inputs: [{ name: 'gemIds', internalType: 'uint256[]', type: 'uint256[]' }],
    name: 'joinBatch',
    outputs: [],
    stateMutability: 'payable',
  },
